...
<script type="text/javascript" src="<%=path%>/static/js/getscript.js"></script>
<!--引用css文件-->
                ...
                <div class="content-wrap" id="content-wrap">
                    ...
                    <div><div id="allmap" style="width:90%;float: right;height:570px;overflow:auto;margin:0px;font-family:"微软雅黑";"></div>
                     <script type="text/javascript">
                                    ...
                                    OLTMENU.addItem(new BMap.MenuItem('配置',setting.bind(OLT)));
                                    ...
                                    "<h4 style='margin:0 0 5px 0;padding:0.2em 0'>OLTINFO</h4>" + 
                                    "<img style='float:right;margin:4px' id='cisco' src='../static/img/cisco.jpg' width='120' height='120' title='cisco'/>" + 
                                    "<p style='margin:0;line-height:1.5;font-size:13px'>名字：思科<br>ID：44946<br>上行：10M/s<br>下行：100M/s</p>" + 
                                    "</div>";
                                    var OLTPOINT2 = new BMap.Point(116.418, 39.915);
                                    var OLTICON2 = new BMap.Icon("../static/img/olt.png", new BMap.Size(23,40));
                                    var OLT2 = new BMap.Marker(OLTPOINT2,{icon:OLTICON});
                                    var OLTinfoWindow2 = new BMap.InfoWindow(OLTINFO2);  // 创建信息窗口对象
                                    ...
                                    OLT2.addEventListener("click", function(){          
                                       this.openInfoWindow(OLTinfoWindow2);
                                       //图片加载完毕重绘infowindow
                                       document.getElementById('cisco').onload = function (){
                                           OLTinfoWindow2.redraw();   //防止在网速较慢，图片未加载时，生成的信息框高度比图片的总高度小，导致图片部分被隐藏
                                       }
                                    });	//左键click动作
                                    
                                    //创建右键菜单
                                    var OLTMENU2 = new BMap.ContextMenu();
                                    OLTMENU2.addItem(new BMap.MenuItem('配置',setting.bind(OLT)));
                                    OLTMENU2.addItem(new BMap.MenuItem('删除',removeMarker.bind(OLT)));
                                    //OLTMENU.addItem(new BMap.MenuItem('重启',removeMarker.bind(OLT)));
                                    //OLTMENU.addItem(new BMap.MenuItem('关闭',removeMarker.bind(OLT)));
                                    
                                    OLT2.addContextMenu(OLTMENU2);
                                    map.addOverlay(OLT2);
                                    ...
                                    var removeMarker2 = function(e,ee,OLT){
                                        map.removeOverlay(OLT);
                                    }
                                    var setting2 = function(e,ee,ONU){
                                    	window.location="<%=basePath%>Setting/manualSet.do";
                                    }
                                    ...
                                    ONUMENU.addItem(new BMap.MenuItem('配置',setting2.bind(ONU)));
                                    ...
                                    ONUMENU2.addItem(new BMap.MenuItem('配置',setting.bind(ONU2)));
                                    ...
                                    var polyline2 = new BMap.Polyline([OLTPOINT2, ONUPOINT2], {strokeColor:"blue", strokeWeight:4, strokeOpacity:0.5});
                                    var polyline3 = new BMap.Polyline([OLTPOINT, OLTPOINT2], {strokeColor:"blue", strokeWeight:4, strokeOpacity:0.5});
                                    //var polyline4 = new BMap.Polyline([OLTPOINT, ONUPOINT2], {strokeColor:"blue", strokeWeight:4, strokeOpacity:0.5});
