    ...
    <div class="TabbedPanelsContent"><!-- 内容 2 -->
       ...
       <body class="TabPanelbody">
        ...
        function onmessage(evt){
            ...
            var speed=data.data;
            console.info(speed);
            option1.series[0].data[0].value = ((speed[1]+Math.random() * (speed[0]-speed[1]))).toFixed(2) - 0;
            option2.series[0].data[0].value = ((speed[3]+Math.random() * (speed[2]-speed[3]))).toFixed(2) - 0;
