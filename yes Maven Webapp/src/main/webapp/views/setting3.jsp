                ...
                <div class="content">
					<!--内容页面开始-->
      				<div style="width:90%;float: right;height:570px;overflow:auto;margin:0px;">
						...
						<!--标题样式结束-->
							<div>
							<label><input type="checkbox" name="hardware" value='123456789'>华为1</label>
							<label><input type="checkbox" name="hardware" value='987654321'>华为2</label>
							<label><input type="checkbox" name="hardware" value='20015998343868'>思科1</label>
							<label><input type="checkbox" name="hardware" value='167633986132668'>思科2</label>
							<br />
...
$("#submit").click(function(){
   ...
   <%--  $.post("<%=basePath%>Database/ConfigPort.do",{vlanChecked:vlanChecked,checkedValue1:checkedValue1,checkedValue2:checkedValue2},function(data){
	...
	$.post("<%=basePath%>Setting/send.do",{checkedValue:checkedValue,msg:msg},function(data){
			alert(data);
		});
	}
